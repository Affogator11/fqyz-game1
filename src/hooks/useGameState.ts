...
export const ACTIONS = {
  study: {
    ...
    icon: 'Pencil',
    description: '分值++ 压力++',
    effects: { academicBase: 2, studyState: 5, stress: 6, health: -2 },
  },
  think: {
    id: 'think',
    name: '整理纠错本',
    icon: 'BookCheck',
    description: '手感++ 压力+',
    effects: { studyState: 8, academicBase: 0.8, stress: 3, happy: 2 },
  },
  run: {
    id: 'run',
    name: '操场喊口号',
    icon: 'Zap',
    description: '压力-- 健康+',
    effects: { stress: -15, health: 10, studyState: 2 },
  },
  eat: {
    id: 'eat',
    name: '食堂抢肉丝',
    icon: 'Utensils',
    description: '幸福++ 压力-',
    effects: { happy: 8, stress: -8, health: 4 },
  },
  sleep: {
    id: 'sleep',
    name: '深度小憩',
    icon: 'Clock',
    description: '健康++ 手感+',
    effects: { health: 12, studyState: 6, stress: -6 },
  },
  phone: {
    id: 'phone',
    name: '违禁手机',
  ...
  chat: {
    ...
    description: '幸福+ 手感-',
    effects: { happy: 4, studyState: -5, stress: -4 },
  },
};
